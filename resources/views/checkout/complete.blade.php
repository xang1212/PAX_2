        ...
        <div class="checkout-section">
            <div class="checkout-section-left">
                <form action="{{ route('checkout.store') }}" method="POST" id="checkout-form">
                    ...
                    <div>
                        <button type="submit" class="button button-blue can-be-disabled checkout-with-credit-card-button" id="checkout-submit-btn">ຢືນຢັນການຊື້ດ້ວຍບັດເຄດິດ</button>
                    </div>
