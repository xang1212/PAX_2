...
@section('content')
    ...
    <div class="container">
        ...
        <h1 class="checkout-heading stylish-heading">ຢືນຢັນການຊື້</h1>
        ...
        <div class="checkout-section">
            <div class="checkout-section-left">
                <form action="{{ route('checkout.validateDetails') }}" method="POST" id="checkout-form">
                    ...
                    <div class="form-group">
                        <label for="phone_number">ເບີໂທລະສັບ</label>
                        <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" required="">
                    </div>

                    <div class="form-group">
                        <label for="billing_address">ທີ່ຢູ່</label>
                    ...
                    <div class="half-form">
                        <div class="form-group">
                            <label for="state">ແຂວງ</label>
                            <input type="text" class="form-control" id="state" name="state" value="{{ old('state') }}" required="">
                        </div>
                        <div class="form-group">
                            <label for="postal_code">ລະຫັດໄປສະນີ</label>
                    ...
                    <div id="shipping-details-container" class="shipping-details-container">
                        ...
                        <div class="half-form">
                            ...
                            <div class="form-group">
                                <label for="city_shipping">ເມືອງ</label>
                    ...
                    <div>
                        <button type="submit" class="button button-blue can-be-disabled" id="checkout-submit-btn">ຕໍ່ໄປ</button>
                    </div>
                </form><!-- end form -->
            </div>
                            ...
                            <div class="checkout-table-row-left">
                                ...
                                <div class="checkout-item-details">
                                    ...
                                    @if (! $item->model->isAvailable())
                                        <span class="badge badge-danger">ບໍ່ມີ</span>
                                    @endif
                                </div>
