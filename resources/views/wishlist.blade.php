    ...
    <div class="breadcrumbs">
        <div class="container">
            <div>
                ...
                <span class="visited">ລາຍການທີ່ມັກ</span>
            </div>
    ...
    <div class="cart-section container">
        <div>
            ...
            @if (Cart::instance('wishlist')->count())
                <h2>{{ Cart::instance('wishlist')->count() }} ສິນຄ້າໃນລາຍການທີ່ມັກ</h2>
            ...
            @else 
                <div class="empty">ບໍ່ມີສິນຄ້າລາຍການທີ່ມັກ!</div>
                <div class="spacer"></div>
                <a href="{{ route('shop.index') }}" class="button button-white">ເລືອກຊື້ສິນຄ້າເພີ່ມເຕີມ</a>
                <div class="spacer"></div>
            @endif
        </div>
