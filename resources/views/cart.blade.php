...
@section('content')
    ...
    <div class="breadcrumbs">
        <div class="container">
            <div>
                <a href="{{ route('home') }}">ໜ້າຫຼັກ</a>
                <i class="fa fa-chevron-right breadcrumb-separator"></i>
                <span class="visited">ກະຕ່າ</span>
            </div>
    ...
    <div class="cart-section container">
        <div>
            ...
            @if (Cart::count())
                <h2>{{ Cart::count() }} ສິນຄ້າໃນກະຕ່າ</h2>
                ...
                <div class="cart-totals">
                    <div class="cart-totals-left">
                        @if (! session()->has('coupon'))
                            <div class="have-coupon-container">
                                <span class="have-coupon">ໃຊ້ຄູປອງ?</span>
                
                                <form id="coupon-form" action="{{ route('coupon.store') }}" method="post">
                                    @csrf

                                    <input type="text" name="code">
                                    <button type="submit" class="button-black">ໃຊ້</button>
                                </form>
                    ...
                    <div class="cart-totals-right">
                        <div class="totals-left">
                            ລາຄາລວມ: <br>
                            ພາສີ: <span class="small-text">({{ config('cart.tax') }}%)</span> <br>
                            <div class="hr"></div>
                            ລາມພາສີ: <br>
                            @if ($discount)
                                ...
                                <form class="remove-coupon-form" action="{{ route('coupon.destroy') }}" method="post">
                                    ...
                                    <button type="submit" class="button-icon-red">ລົບອອກ</button>
                                </form>
                                <br>
                            @endif
                ...
                <div class="cart-buttons">
                    <a href="{{ route('shop.index') }}" class="button button-white">ເລືອກຊື້ເພີ່ມເຕີມ</a>
                    <a href="{{ auth()->user() ? route('checkout.detailsIndex') : route('loginToCheckout') }}" class="button button-green proceed-to-checkout-button">ດຳເນີນການຊຳລະເງິນ</a>
                </div>
            @else 
                <div class="empty">ບໍ່ມີສິນຄ້າໃນກະຕ່າ!</div>
