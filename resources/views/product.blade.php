    ...
    <div class="breadcrumbs">
        <div class="container">
            <div>
                ...
                <a href="{{ route('shop.index') }}">ສິນຄ້າ</a>
                <i class="fa fa-chevron-right breadcrumb-separator"></i>
    ...
    <div class="product-section container">
        ...
        <div class="product-section-information">
            <div class="product-section-first-row">
                <div class="product-section-title-badges">
                    ...
                    <div class="product-badges">
                        ...
                        @if ($product->isNew())
                            <span class="badge product-badge-new">ໃໝ່</span>
                        @endif    
                ...
                @if ($product->isInWishlist())
                    ...
                    <form class="heart-item-form" action="{{ route('wishlist.destroy', $product->getCartRowId('wishlist')) }}" method="post">
                        ...
                        <button type="submit" class="button-icon" title="Remove from Wishlist">
                            <span class="remove-from-wishlist">ລົບອອກຈາກລາຍການທີ່ມັກ</span>&nbsp;<i class="fas fa-heart solid-heart"></i>
                        </button>
                    </form>
                @else
                    ...
                    <form class="heart-item-form" action="{{ route('wishlist.store') }}" method="post">
                        ...
                        <button type="submit" class="button-icon" title="Add to Wishlist">
                            <span class="add-to-wishlist">ເພີ່ມໃນລາຍການທີ່ມັກ</span>&nbsp;<i class="far fa-heart"></i>
                        </button>
                    </form>
                @endif
            </div>
            ...
            @if ($product->isAvailable())
                @if ($product->isInCart())
                    <div class="alert-success">ຢູ່ໃນກະຕ່າແລ້ວ</div>
                @else 
                    <form action="{{ route('cart.store') }}" method="post">
                        ...
                        <input type="hidden" name="name" value="{{ $product->name }}">
                        <input type="hidden" name="price" value="{{ $product->price }}">
                        <button class="button button-plain add-to-cart-btn" type="submit">ເພີ່ມລົງກະຕ່າ <i class="fa fa-cart-plus"></i></button>
                    </form>
                @endif
            @endif
        </div>
