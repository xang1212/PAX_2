    ...
    <div class="breadcrumbs">
        <div class="container">
            <div>
                ...
                @else
                    <span class="visited">ສິນຄ້າ</span>
                @endif
            </div>
    ...
    <div class="products-section container">
                ...
                <ul class="sort-by-price-list">
                    <li class="{{ request()->sort == 'high_low' ? 'active' : ''}}">
                        @if (request()->sort == 'high_low')
                            <span>ລາຄາຕ່ຳສຸດ</span>
                        @else
                            <a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'high_low']) }}">ລາຄາສູງສຸດ</a>
                        @endif
                    </li>
                    <li class="{{ request()->sort == 'low_high' ? 'active' : ''}}">
                        @if (request()->sort == 'low_high')
                            <span>ລາຄາຕ່ຳສຸດ</span>
                        @else
                            <a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'low_high']) }}">ລາຄາສູງສຸດ</a>
                        @endif
                    </li>
        ...
        <div class="products-section-all">
            ...
            <div class="products text-center">
                ...
                @empty
                    <div class="empty">ບໍ່ພົບສິນຄ້າ</div>
                @endforelse
            </div> <!-- end products -->
